        ...
        <div class="row mb-5 mt-5 mx-5">
            <div class=" col-lg-8 offset-lg-2  col-sm-12 form-login">
                <div class="form-heading p-1">
                    <div class="w-100 form-title text-center">Edit Your Info</div>
                </div>
                    ...
                    <form action="<?php echo $base_url; ?>?r=edituser&id=<?php echo $id; ?>" method="post">
                        ...
                        <div class="input-group  my-4">
                            ...
                            <div class="col-lg-8 col-7">
                                <input name="txtFName" type="text" style="border-color:#deac46;" class="form-control"
                                    value="<?= $user_data['u_fname'] ?>" aria-label="name"
                        ...
                        <div class="input-group  my-4">
                            ...
                            <div class="col-lg-8 col-7">
                                <input name="txtLName" type="text" style="border-color:#deac46;" class="form-control"
                                    value="<?= $user_data['u_lname'] ?>" aria-label="name"
                                    aria-describedby="basic-addon1">
                            </div>
                        </div>
                        ...
                        <div class="input-group  my-4">
                            ...
                            <div class="col-lg-8  col-7">
                                <input name="txtEmail" type="email" style="border-color:#deac46;" class="form-control"
                                    value="<?= $user_data['u_email'] ?>" aria-label="email"
                                    aria-describedby="basic-addon1">
                        ...
                        <div class="input-group  my-4">
                            ...
                            <div class="col-lg-8  col-7">
                                <input name="txtPhone" type="text" style="border-color:#deac46;" class="form-control"
                                    value="<?= $user_data['u_phone'] ?>" aria-label="email"
                                    aria-describedby="basic-addon1">
                            </div>
                        </div>
                        <div class="input-group mb-3">
                            ...
                            <div class="col-lg-8 col-7">
                                <input name="txtAddress" type="text" style="border-color:#deac46;" class="form-control"
                                    value="<?= $user_data['u_address'] ?>" aria-label="address"
                                    aria-describedby="basic-addon1">
                            </div>
                        </div>
                        <div class="input-group mb-3">
                            ...
                            <div class="col-lg-8 col-7">
                                <input name="txtPassword" type="password" style="border-color:#deac46;"
                                    class="form-control" value="<?= $user_data['u_password'] ?>" aria-label="password"
                                    aria-describedby="basic-addon1">
                            </div>
                        </div>
                        <!-- <div class="input-group mb-3">
